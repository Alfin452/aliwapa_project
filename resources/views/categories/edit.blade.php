<x-app-layout>
    <div class="bg-slate-50 min-h-screen flex items-center justify-center p-4">
        <div class="bg-white max-w-lg w-full rounded-2xl shadow-lg border border-gray-200 p-8">
            <h2 class="text-xl font-bold text-gray-900 mb-6">Edit Kategori</h2>
            ...
            <form action="{{ route('categories.update', $category->id) }}" method="POST">
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input type="text" name="kode_ddc" value="{{ old('kode_ddc', $category->kode_ddc) }}" class="w-full rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_kategori" value="{{ old('nama_kategori', $category->nama_kategori) }}" class="w-full rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500" required>
                    ...
                    <div class="flex gap-3 pt-4">
                        ...
                        <button type="submit" class="flex-1 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 shadow-lg">Update</button>
                    </div>
                </div>
            </form>
        </div>
